  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex p-4 md:p-6 flex-col gap-3 items-center justify-center">
      <div className="w-full flex flex-col md:flex-row max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl bg-white rounded-[20px] overflow-hidden shadow-2xl mx-auto ">
        ...
        {/* Left Side */}
        <div
          className="hidden md:flex relative showBg w-full md:w-1/2 bg-[#0c0c27] lg:border-[16px] lg:rounded-l-4xl text-white p-4 md:p-10  md:flex-col justify-between"
        ...
        {/* Right Side */}
        <div className="w-full h-full md:w-1/2 py-6 px-4 sm:px-8 md:p-10 relative overflow-y-auto max-h-[90vh] flex items-center">
          <button
            onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="flex w-full mx-5 lg:mx-0 flex-col space-y-3.5 xl:space-y-8 2xl:space-y-12 xl:pt-6 text-black">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-fit flex items-center gap-2 px-6 py-4 xl:px-10 rounded-full font-semibold transition-all
