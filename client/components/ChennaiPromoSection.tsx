  ...
  return (
      <div className="w-full flex flex-col md:flex-row items-center justify-center py-16 gap-8 2xl:gap-16 3xl:gap-20 4xl:gap-24 px-6 2xl:px-16">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <Link
            href="/our-fleet"
            className="relative overflow-hidden cursor-pointer inline-block text-lg md:text-2xl font-semibold !text-white secondary-btn border border-black px-5 py-3 rounded-full
