                                        ...
                                        <li key={notification._id} className={`group relative border-b last:border-0 border-gray-50 transition-colors hover:bg-gray-50 ${notification.status === 2 ? 'bg-blue-50/60' : ''}`}>
                                            ...
                                            <div className="absolute bottom-2 right-2 flex gap-1 z-10">
                                                ...
                                                <button
                                                    ...
                                                    className="p-1.5 cursor-pointer rounded-full bg-white shadow-sm border border-gray-200 hover:text-red-600 hover:border-red-200 transition-colors disabled:opacity-50"
                                                    title="Delete"
                                                >
